...
import 'dart:io';
import 'package:gen_i18n/extra_json_message_tool.dart';
import 'package:gen_i18n/generate_i18n_dart.dart';
import 'package:gen_i18n/extra_json_file_tool.dart';
import 'package:gen_i18n/print_tool.dart';
import 'package:gen_i18n/generate_message_all.dart';
            ...
            if (hasArgsInMessage(message.message!)) {
              messageBuilder.writeln(generateKeyWithValue(
                  ...
                  generateMessageFunction(
                      extraArgsFromMessage(message.message!), message.message!.replaceAll(r'\\$', r'\$'))));
            } else {
              messageBuilder.writeln(generateKeyWithValue(
